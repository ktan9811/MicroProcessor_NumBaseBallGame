...
void GLCD_gotoXY(unsigned char x, unsigned char y)		//Ŀ�� ��ǥ �̵�
{
...
void GLCD_character (char data, char CS)				//CS�� �Էµ� Char ���
{
	if (CS  == 1) CS = CS2_OFF;
...
void GLCD_String(unsigned char *str, char CS)			//CS�� �Էµ� str ���
{
	while (*str)
	{
...
void print_GLCD(unsigned char x)				//Print UserInput at CS1, Print SB statuse at CS2
{
	...
	Write_Control(CS_ALL, 0xb8+x);			//���� �Ǵ��� Ȯ��
	Write_Control(CS_ALL, 0x40);				//��������
	GLCD_String("S: ", 2);
...
{
	int temp;
	ADMUX = (char)ch | 0xC0;	//1100_0000		[7:6]2.56�� ��������, ��������, [4:3]���� ������,[2:0] ä��
	ADCSRA=ADCSRA|(0x01<<6);	//������ ����
	temp = ADCL;				//ADCL�� ����
	return ((ADCH<<8)|temp);	//High, Low ��ġ��
}
